...
export const ICONS = {
  ...
  Maintenance: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.423 20.407a2.851 2.851 0 002.74 0l6.75-4.05a2.852 2.852 0 000-4.883l-6.75-4.05a2.851 2.851 0 00-2.74 0l-6.75 4.05a2.852 2.852 0 000 4.883l6.75 4.05z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 7.5L12 9.75 8.25 7.5 12 5.25 15.75 7.5z" />
    </svg>
  ),
  Phone: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
